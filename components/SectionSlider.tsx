...
import SwiperCore, { Virtual, Navigation, Pagination, Thumbs } from 'swiper/modules';
...
// SwiperCore.use([Virtual, Navigation, Pagination, Thumbs]);
...
function SectionSlider({ sectionTitle, products }: SectionSliderProps) {
