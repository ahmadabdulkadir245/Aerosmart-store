...
import SwiperCore, { Grid, Pagination } from 'swiper/modules';
...
interface GridSectionSliderProps {
  sectionTitle: string;
  products: Product[];
}

function GridSectionSlider({ sectionTitle, products }: GridSectionSliderProps) {
