...
const CartPage = () => {
  ...
  return (
    <div className="bg-white">
      <Container>
      <div className='pt-5 lg:pt-10 lg:grid grid-cols-3 m-auto  lg:max-w-7xl max-h-[calc(100vh-132px)] lg:h-full transition-all duration-500 ease-in overflow-y-scroll scrollbar-hide'>
